...
///usr/local/cuda-8.0/bin/nvcc cudnn_conv_int8.cu -std=c++11    -I/usr/local/cuda-8.0/include    -I/media/hdd/fjm/package/cudnn_v6/include  -L/usr/local/cuda-8.0/lib64  -lcublas -lcudart -L/media/hdd/fjm/package/cudnn_v6/lib64  -lcudnn  -gencode arch=compute_61,code=sm_61  
...
//std::cout<<"size = "<<conv1.pconv.size()<<std::endl; for(auto&d : conv1.pconv) std::cout<<d<<std::endl;
